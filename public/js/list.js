class CCList {
    ...
    async loadFilter () {
        try {
            ...
            this.populateSelectFromKeys( selects[ 3 ], stats.series );
            this.populateSelectFromKeys( selects[ 4 ], stats.country );
            this.populateSelectFromKeys( selects[ 5 ], stats.currency );
            this.populateSelectFromKeys( selects[ 6 ], stats.issuer );
            this.populateSelectFromKeys( selects[ 7 ], stats.mintMark );
            this.populateSelectFromKeys( selects[ 8 ], stats.year );
            this.populateSelectFromKeys( selects[ 9 ], stats.material, I18N.material );
    ...
    fromHash () {
        try {
            ...
            [ 'type', 'status', 'grade', 'series', 'country', 'currency', 'issuer', 'mintMark', 'year', 'material' ].forEach( key => {
